        ...
        <div class="h-100">
            ...
            <ul id="sidebar-nav">
                <li class="sidebar-item">
                    <a href="../profile/index.php" class="sidebar-link" onclick="redirectTo('../profile/index.php')">
                ...
                <li class="sidebar-item">
                    <a href="../items/index.php" class="sidebar-link active" onclick="redirectTo('../items/index.php')">
